...
func (api *DemoApi) DemoOrm(c *gin.Context) {
	...
	logger.Debug(c, "request start", nil)
	...
	logger.Debug(c, "insert user", map[string]interface{}{
		"id":  user.ID,
		"err": err,
	})
	...
	logger.Debug(c, "update user", map[string]interface{}{
		"err": err,
		"id":  user.ID,
	})
	...
	logger.Debug(c, "query user", map[string]interface{}{
		"err":  err,
		"name": queryUser.Name,
	})

	logger.Debug(c, "delete user", map[string]interface{}{
		"err": err,
		"id":  user.ID,
	})
	c.JSON(200, "ok")
